...
export type ReceptionDomain = z.infer<typeof receptionDomainSchema>;

export const receptionRoutedSpecialistSchema = z.enum(['it', 'hr', 'logistics']);

export type ReceptionRoutedSpecialist = z.infer<typeof receptionRoutedSpecialistSchema>;
...
export type ReceptionTurnOutput = z.infer<typeof receptionTurnOutputSchema>;
