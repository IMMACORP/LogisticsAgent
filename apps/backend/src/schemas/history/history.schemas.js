...
import { createPaginatedSchema, paginationQuerySchema, } from '../pagination/pagination.schemas.js';
...
export const paginatedConversationHistorySchema = createPaginatedSchema(conversationHistoryItemSchema, 'PaginatedConversationHistory');
...
export const paginatedMessageHistorySchema = createPaginatedSchema(messageHistoryItemSchema, 'PaginatedMessageHistory');
...
export const paginatedEscalationHistorySchema = createPaginatedSchema(escalationHistoryItemSchema, 'PaginatedEscalationHistory');
