...
function skipIfIdempotent(ctx) {
    return ctx.state.idempotentReplay === true;
}
async function auditStep(ctx, action, newValues) {
...
export function createEscalationWorkflow() {
    return {
        ...
        steps: [
            ...
            },
            {
                ...
                run: async (ctx) => {
                    ...
                    const evaluation = ctx.state.evaluation;
            ...
            },
            {
                ...
                run: async (ctx) => {
                    ...
                    const payload = ctx.state.structuredPayload;
                    const input = ctx.state.input;
            ...
            },
            {
                ...
                run: async (ctx) => {
                    ...
                    const payload = ctx.state.structuredPayload;
                    const input = ctx.state.input;
                    const slack = ctx.state.slackResult;
