...
import {
  ...
  paginatedConversationHistorySchema,
  paginatedEscalationHistorySchema,
  paginatedMessageHistorySchema,
} from '../schemas/history/history.schemas.js';
...
export function createHistoryOpenApiRouter(): OpenAPIHono {
