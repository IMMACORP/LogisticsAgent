export interface UserFacingOpenAIError {
  code: string;
  message: string;
  recoverable: boolean;
}
 ...
 */
export function toUserFacingOpenAIError(raw: string): UserFacingOpenAIError {
